...
function LuxuryMen() {
  // Get premium/luxury tagged men's products
  const luxury = menProducts.filter(p => p.tag === 'Premium' || p.tag === 'Exclusive')

  return (
    <div className="shop-page">
      <div className="shop-page__header">
        <p className="eyebrow" style={{ textAlign: 'center' }}>For Him</p>
        <h1 className="shop-page__title">Men's Luxury Scents</h1>
